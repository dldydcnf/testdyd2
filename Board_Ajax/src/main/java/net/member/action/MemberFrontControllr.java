...
@WebServlet("*.net")
public class MemberFrontControllr extends javax.servlet.http.HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 ...
		 예) contextPath가 "/JspProject"인 경우
		 	http://localhost:8088/JspProject/login.net로 요청하면 getRequestURI()는 "/JspProject/login.net" 반환됩니다.
		 */
