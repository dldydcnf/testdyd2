...
function setPaging (href, digit){
	...
	if(href==""){//href가 빈문자열인 경우
		if(isNaN(digit)){//이전&nbsp; 또는 다음 &nbsp;
			gray="gray"; //11, 20번 라인 처럼 href 속성이 없고 <a>요소의 textnode가 숫자가
		}else{
			active="active"; //12, 19번 라이 처럼 href 속성이 없고 <a>요소의 textnode가
		}
	}
	let output = `<li class="page-item${active}">`;
	//let anchor = "<a class = 'page-link" + gray + "'" + href+ ">" + digit + "
