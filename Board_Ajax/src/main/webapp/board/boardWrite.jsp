...
<body>
 ...
 <form action="BoardAddAction.bo" method="post" enctype="multipart/form-data" name="boardform">
  ...
  <div class="form-group">
  	...
  	<input name="board_pass" id="board_pass" maxlength="30" placeholder="Enter board_pass"
  			type="password"		class="form-control"
  			placeholder="Enter board_name">
  </div>
  <div class="form-group">
  <label for="board_subject">제목</label>
  	<input name="board_subject" id="board_subject" maxlength="100" placeholder="Enter board_subject"
  			type="text"		class="form-control">
  </div>
  <div class="form-group">
